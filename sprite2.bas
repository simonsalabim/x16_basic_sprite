...
260 NEXT I
270 REM
280 REM **NOW LETS SET UP SPRITES LIKE IN LESSON 1
290 REM
...
360 GOSUB 1000
440 REM
450 REM **THIS TIME WE SET THE HEIGHT AND WIDTH TO 32 (1010)
460 REM
470 REM **WE MOVE THE SPRITE USING THE POSITION ATTRIBUTES
480 REM
490 REM **** MOVE SPRITE ****
500 GET A$ : IF A$="" THEN 500
510 A=ASC(A$)
520 IF A=68 THEN X = X + 1 : IF X > 288 THEN X = 288 : REM D
530 IF A=65 THEN X = X - 1 : IF X < 0 THEN X = 0 : REM A
540 IF A=87 THEN Y = Y - 1 : IF Y < 0 THEN Y = 0 : REM W
550 IF A=88 THEN Y = Y + 1 : IF Y > 168 THEN Y = 168 : REM X
560 IF A=81 THEN 600 : REM Q
570 VPOKE $1, $FC02, X AND $FF
575 VPOKE $1, $FC03, INT(X/256)
580 VPOKE $1, $FC04, Y
590 GOTO 500
600 REM
610 REM **THERE IS SOMETHING SPECIAL ABOUT SPRITE 0 (THE ONE WE ARE USING)
620 REM **IT IS SPRITE FOR THE MOUSE CURSOR
630 REM **IF WE TURN ON THE MOUSE AND RESET OUR SPRITE, BIG BOX MOUSE!
640 MOUSE 1
650 GOSUB 1000
660 END
